...
| `GET` | `/api/v1/admin/users/surveys` | List surveys across users, optionally filtered by `user_id` |
| `GET` | `/api/v1/admin/users/{user_id}/survey-summary` | Get one user's survey and response totals |
