...
DEFAULT_FINANCIAL_OUTPUT: dict[str, Any] = {
    ...
    "revenue_model_options": [
        "Tiered recurring subscription (SaaS) with monthly and discounted annual billing",
        "Usage-based add-ons based on transaction volume or active user seats",
    ],
    "pricing_consideration_notes": [
        "Introduce an accessible entry tier to minimize adoption friction for early adopters",
        "Target gross margins above 70% by closely monitoring direct compute and third-party API costs",
    ],
    ...
    "financial_risk_flags": [
        "Customer willingness to pay at target pricing tiers requires empirical validation",
    ...
    "unit_economics_summary": {
        ...
        "estimated_ltv": "Dependent on monthly churn rate and subscription pricing tier",
        "ltv_to_cac_ratio": "Target 3.0x+ upon reaching product-market fit",
        "gross_margin_pct": "70% - 85%",
