...
### Predefined Prompt Options & Suggestions:
- **[1] Tiered Subscription (SaaS)** — *"Monthly or annual recurring subscription per user/seat."*
- **[2] Freemium Model** — *"Free entry tier for distribution + premium feature upgrade."*
- **[3] Transaction / Commission Fee** — *"Take-rate percentage on marketplace transactions or payments."*
- **[4] Usage-Based / Pay-As-You-Go** — *"Billed on consumption (API calls, storage, data processed)."*
...
The agent must capture:
- **pricing_assumption**: Specific target price point or subscription fee.

### Predefined Prompt Options & Suggestions:
- **[1] Entry / Consumer Tier** — *"$9 - $29 / month (or ₹499 - ₹1,999 / mo)"*
- **[2] Pro / Mid-Market Tier** — *"$49 - $149 / month (or ₹2,499 - ₹7,999 / mo)"*
- **[3] Enterprise / High-Ticket** — *"$250+ / month (or ₹15,000+ / mo)"*
- **[4] Transaction Take-Rate** — *"2% to 5% per processed transaction"*
